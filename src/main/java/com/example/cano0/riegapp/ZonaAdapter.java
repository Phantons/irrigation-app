...
public class ZonaAdapter extends ArrayAdapter<Zone> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            viewHolder.zonaNRegar = (Button) view.findViewById(R.id.zonaNRegar);
        ...
        viewHolder.zonaNRegar.setTag(R.integer.zonaNRegar_pos, position);
        viewHolder.zonaN.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {

                //entra en la zona seleccionada
        ...
        viewHolder.zonaNRegar.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
                //entra en la zona seleccionada
                boolean regarYa = (viewHolder.zonaNRegar.getText().toString().toLowerCase() == "regar ya");
                Integer pos = (Integer) viewHolder.zonaNRegar.getTag(R.integer.zonaNRegar_pos);
                RegarModeTask regarModeTask = new RegarModeTask(list.get(pos), 10, viewHolder.zonaNRegar, regarYa, UsuarioClass.getControladorList().get(nControlador), context);
                regarModeTask.execute((Void) null);
            }
        });
